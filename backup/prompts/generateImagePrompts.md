...
若某鏡頭是前一鏡頭的延續，必須延用前一鏡頭設定，不可重置畫面邏輯。

---

# 七、Prompt 組成公式

每個 prompt_text 必須依照以下結構：
...
6. 不輸出前言說明
7. shots 數量必須正確
8. grid_layout 必須自動計算
9. 每個 shot 必須包含 grid_aspect_ratio
10. 每個 prompt_text 必須以固定超清後綴結尾
